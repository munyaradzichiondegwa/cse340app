...
inventoryController.showVehicleDetail = async (req, res, next) => {
  const invId = parseInt(req.params.invId || req.params.inv_id);
  ...
  try {
    ...
    res.render("inventory/detail", {
      ...
      nav,
      inventory: vehicle,            // FIX: Pass vehicle data as `inventory`
      reviews: Array.isArray(reviews) ? reviews : [], // Always an array
      errors: null,
      messages: req.flash(),
